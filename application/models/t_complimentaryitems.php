...
/**
 *T_User
 *Description: model manage t_complimentaryitems
 * @author quanhm
 */
Class T_complimentaryitems extends MY_Model
{
    function __construct()
    {
        parent::__construct();
        $this->table_name = 't_complimentaryitems';
    }
     ...
     *function set_data
     *
     *Set data t_complimentaryitems
     * @param:
     *    param 1 : array data t_complimentaryitems
     *    param 2 : result return condition
     * @return id_t_complimentaryitems|object t_complimentaryitems|null
     * @author quanhm
     *
     **/
    function set_data($data = array(), $result = 0)
    {
        ...
        if ($result == 0) {
            ...
            $t_complimentaryitems = $this->get_data_by_id('*', $id_last);
            return $t_complimentaryitems;
        }
    }
     ...
     *
     *Update data t_complimentaryitems by id
     * @param:
     *    param 1 : array data t_complimentaryitems
     *    param 2 : id t_complimentaryitems
     * @return true|false
     * @author quanhm
     *
     **/
     ...
     *
     *Update data t_complimentaryitems by property
     * @param:
     *    param 1 : array data t_complimentaryitems
     *    param 2 : condition
     * @return true|false
