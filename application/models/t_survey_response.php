...
/**
 *T_User
 *Description: model manage t_survey_response
 * @author quanhm
 */
Class T_survey_response extends MY_Model
{
    function __construct()
    {
        parent::__construct();
        $this->table_name = "t_survey_response";
    }
    ...
    public function get_data_by_id($select = '*', $id = null)
    {
        ...
        if (!is_null($id) && is_numeric($id)) {
            $this->db->where("id_gs = $id LIMIT 1");
        } else {
            return null;
        }
        //select data
     ...
     *function set_data
     *
     *Set data t_growth_stage
     * @param:
     *    param 1 : array data t_growth_stage
     *    param 2 : result return condition
     * @return id_t_growth_stage|object t_growth_stage|null
     * @author quanhm
     *
     **/
    public function set_data($data = array(), $result = 0)
    {
        ...
        if ($result == 0) {
            ...
            $t_growth_stage = $this->get_data_by_id('*', $id_last);
     ...
     *
     *Update data t_growth_stage by id
     * @param:
     *    param 1 : array data t_growth_stage
     *    param 2 : id t_growth_stage
     * @return true|false
     * @author quanhm
     *
     **/
     ...
     *
     *Update data t_growth_stage by property
     * @param:
     *    param 1 : array data t_growth_stage
     *    param 2 : condition
     * @return true|false
