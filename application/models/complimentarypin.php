...
/**
 *T_User
 *Description: model manage complimentarypin
 * @author quanhm
 */
Class Complimentarypin extends MY_Model
{
    function __construct()
    {
        parent::__construct();
        $this->table_name = 'complimentarypin';
    }
     ...
     *function set_data
     *
     *Set data complimentarypin
     * @param:
     *    param 1 : array data complimentarypin
     *    param 2 : result return condition
     * @return id_complimentarypin|object complimentarypin|null
     * @author quanhm
     *
     **/
    function set_data($data = array(), $result = 0)
    {
        ...
        if ($result == 0) {
            ...
            $complimentarypin = $this->get_data_by_id('*', $id_last);
            return $complimentarypin;
        }
    }
     ...
     *
     *Update data complimentarypin by id
     * @param:
     *    param 1 : array data complimentarypin
     *    param 2 : id complimentarypin
     * @return true|false
     * @author quanhm
     *
     **/
     ...
     *
     *Update data complimentarypin by property
     * @param:
     *    param 1 : array data complimentarypin
     *    param 2 : condition
     * @return true|false
