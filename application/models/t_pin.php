...
/**
 *T_User
 *Description: model manage t_pin
 * @author quanhm
 */
Class T_pin extends MY_Model
{
    function __construct()
    {
        parent::__construct();
        $this->table_name = 't_pin';
    }
    ...
    function get_data_by_id($select = '*', $id = null)
    {
        ...
        if (!is_null($id) && is_numeric($id)) {
            $this->db->where("id_pin = $id LIMIT 1");
        } else {
            return null;
        }
        //select data
     ...
     *Set data t_pin
     * @param:
     *    param 1 : array data t_pin
     *    param 2 : result return condition
     * @return id_t_pin|object t_pin|null
     * @author quanhm
     *
     **/
    function set_data($data = array(), $result = 0)
    {
        ...
        if ($result == 0) {
            ...
            $t_pin = $this->get_data_by_id('*', $id_last);
            return $t_pin;
        }
    }
