 ...
 * @author quanhm
 */
Class T_purpose extends MY_Model
{
    function __construct()
    {
        parent::__construct();
        $this->table_name = 't_purpose';
    }
    ...
    function get_data_by_id($select = '*', $id = null)
    {
        ...
        if (!is_null($id) && is_numeric($id)) {
            $this->db->where("CD_PURPOSE = $id LIMIT 1");
        } else {
            return null;
        }
        //select data
     ...
     *Set data t_purpose
     * @param:
     *    param 1 : array data t_purpose
     *    param 2 : result return condition
     * @return id_t_purpose|object t_purpose|null
     * @author quanhm
     *
     **/
    function set_data($data = array(), $result = 0)
    {
        ...
        if ($result == 0) {
            ...
            $t_purpose = $this->get_data_by_id('*', $id_last);
            return $t_purpose;
        }
    }
     ...
     *
     *Update data t_purpose by id
     * @param:
     *    param 1 : array data t_purpose
     *    param 2 : id t_purpose
     * @return true|false
     * @author quanhm
     *
     **/
     ...
     *
     *Update data t_purpose by property
     * @param:
     *    param 1 : array data t_purpose
     *    param 2 : condition
     * @return true|false
