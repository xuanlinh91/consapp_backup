...
(function() {
            ...
            p(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        if (a.dataMax < d) a.dataMax = d, a.ignoreMaxPadding = !0
                    }
                }
            })
        },
    ...
    O.prototype = {
        ...
        processData: function(a) {
            ...
            if (b[0] < o || b[d - 1] > n) e = this.cropData(this.xData, this.yData, o, n), b = e.xData, c = e.yData,
        ...
        setState: function(a,
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic) g = g && this.graphic.symbolName && p.r, this.graphic.attr(w(p, g ? {
                    ...
                    if (l) e.stateMarkerGraphic = k = m.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(p).add(e.markerGroup), k.currentSymbol = l;
